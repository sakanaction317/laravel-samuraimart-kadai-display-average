        ...
        <div class="col-md-5">
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror samuraimart-login-input" name="name" value="{{ old('name') }}" required authfocus placeholder="侍 太郎">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-7">
                        <input type="email" id="email" class="form-control @error('email') is-invalid @enderror samuraimart-login-input" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="samurai@samurai.com">
