            ...
            <form action="{{ route('mypage') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show editUserName">
                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" required autocomplete="name" autofocus placeholder="侍 太郎">
                        @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="collapse show editUserPhone">
                        <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $user->phone }}" required autocomplete="phone" autofocus placeholder="XXX-XXXX-XXX">
                        @error('phone')
