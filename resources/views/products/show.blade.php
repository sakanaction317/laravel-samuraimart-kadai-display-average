 ...
 <div class="d-flex justify-content-center">
     <div class="row w-75">
         ...
         <div class="col">
                 ...
                 <div class="row">
                     ...
                     <div class="col-5">
                         @if(Auth::user()->favorite_products()->where('product_id', $product->id)->exists())
                            <a href="{{ route('favorites.destroy', $product->id) }}" class="btn samuraimart-favorite-button text-favorite w-100" onclick="event.preventDefault(); document.getElementById('favorite-destroy-form').submit();">
             ...
             <form action="{{ route('favorites.destroy', $product->id) }}" id="favorite-destroy-form" method="post" class="d-none">
                @csrf
                @method('DELETE')
             </form>
             ...
             <div class="row">
                 <div class="offset-md-5 col-md-5">
                     <form method="POST" action="{{ route('reviews.store') }}">
                         @csrf
                         <h4>評価</h4>
                         <select name="score" class="form-control mt-2 review-score-color">
