...
class ProductController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('reccmmend_flag', __('Recommend Flag'));
        ...
        $grid->filter(function($filter){
            ...
            $filter->equal('reccmmend_flag', 'おすすめフラグ')->select(['0' => 'false', '1' => 'true']);
    ...
    protected function detail($id)
    {
        ...
        $show->field('reccmmend_flag', __('Recommend_Flag'));
    ...
    protected function form()
    {
        ...
        $form->switch('reccmmend_flag', __('Recommend Flag'));
